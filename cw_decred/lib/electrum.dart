...
class ElectrumClient {
  ...
  Future<List<int>> feeRates() async {
    try {
      ...
      final top =
          (stringDoubleToDecredAmount(topDoubleString.toString()) / 1000)
              .round();
      final middle =
          (stringDoubleToDecredAmount(middleDoubleString.toString()) / 1000)
              .round();
      final bottom =
          (stringDoubleToDecredAmount(bottomDoubleString.toString()) / 1000)
              .round();
